              ...
              <div className="mt-3 sm:mt-8 sm:flex flex-col  justify-center">
                <span href="/dashboard">
                  <button
                    ...
                    }  shadow bg-blue-600 text-sm md:text-lg md:w-96 w-64 flex items-center justify-center px-8 py-3 border border-transparent  font-medium rounded-xl text-white  md:py-4  md:px-10`}
                  >
                    Create Account
                  </button>
                </span>
